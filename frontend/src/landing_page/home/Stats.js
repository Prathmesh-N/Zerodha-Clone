        ...
        <div className='container p-5'>
            <div className='row p-5'>
                <div className='col-6 p-5'>
                    <h1 className='fs-1 mb-5'>Trust with condidence</h1>
                    <h2 className='fs-4'>Customer-first always</h2>
                    <p className='text-muted'>That's why 1.3+ crores customers trust Zerodha with â‚¹3.5 lakh crores of equity investments.</p>
